...
from tbot_api.enums import ContentType
from tbot_api.methods import (
    CopyMessage,
    DeleteMessage,
    EditMessageCaption,
...
from tbot_api.types.message import Message
...
class TestMessage:
    ...
    def test_content_type(self, message: Message, content_type: str) -> None:
    ...
    def test_edit_reply_markup(self) -> None:
    ...
    def test_delete_reply_markup(self) -> None:
        reply_markup = InlineKeyboardMarkup(
            inline_keyboard=[
                [
                    InlineKeyboardButton(
    ...
    def test_edit_live_location(self) -> None:
        message = Message(
            message_id=42, chat=Chat(id=42, type="private"), date=datetime.datetime.now()
        )
    ...
    def test_stop_live_location(self) -> None:
        message = Message(
            message_id=42, chat=Chat(id=42, type="private"), date=datetime.datetime.now()
        )
    ...
    def test_edit_caption(self) -> None:
        message = Message(
            message_id=42, chat=Chat(id=42, type="private"), date=datetime.datetime.now()
        )
